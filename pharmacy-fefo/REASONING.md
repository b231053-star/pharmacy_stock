...
| :--- | :--- | :--- | :--- | :--- |
| **TC-01** | Clock step-forward (`POST /clock`) | Mark expired batches as `QUARANTINED`, flag $\le 7$ days as `EXPIRING_SOON` | DB updated, status counts returned | **PASS** |
...
| **TC-05** | Automated smoke suite (`test-fefo.sh`) | End-to-end API health, search, FEFO deduction, alerts | All 4 probes passed | **PASS** |
